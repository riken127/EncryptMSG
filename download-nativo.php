...
<head>
    ...
    <title>EncryptMSG - Download Nativo</title>
      ...
      <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            <li><a class="dropdown-item fw-bold" href="download-nativo.php">Nativo</a></li>
            <li><hr class="dropdown-divider"></li>
            <li><a class="dropdown-item" href="download-mobile.php">Mobile</a></li>
          </ul>
        </li>
        <li><a href="help.php" class="nav-link px-2 link-dark">Ajuda</a></li>
      </ul>
...
<h2 class="fw-bold junteseanos-text">Faça o download da versão nativa!</h2>
<br>
<br>
<hr style="width:127px; margin: auto;" />
<br>
<br>
<div class="junteseanos-text">
<h4 class="fw-bold">Faça agora download da versão mais<br>
    recente do EncryptMSG - Desktop.<br><h4>
        <h5>Aplicação desenvolvida em vb.net,<br>
        com compatibilidade com a<br>aplicação WEB e MOBILE.<br>
        </h5>
                <br>
                <i class="fa-solid fa-computer fa-10x "></i>
                <br>
                <br>
        <button type="button" class="btn-ctr btn btn-outline-primary"><b>Download • </b><i class="fa-solid fa-download fa-1x"></i></button>
      <div class="conteudo-nativo">
